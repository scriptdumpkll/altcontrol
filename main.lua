...
loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptdumpkll/altcontrol/main/gui.lua"))()
...
game:GetService('UserInputService').InputBegan:Connect(function(Key)
	if Key.KeyCode == Enum.KeyCode[Keybind:upper()] and not game:GetService('UserInputService'):GetFocusedTextBox() then
		if ScreenHide then
			setfpscap(60)
